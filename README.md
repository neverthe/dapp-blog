...
## 🌟 核心功能模块
#### 📝 文章管理系统
- 发布文章 - 内容存储到 IPFS，标题和元数据上链永久保存
- 编辑删除 - 作者可修改或软删除自己的文章
- 文章列表 - 支持分页、按标题/作者/标签搜索、按时间排序
- 内容展示 - 从 IPFS 获取文章内容并渲染
#### 💬 社交互动系统
...
- Ethers.js - 合约交互和部署库（ Hardhat 内置的Ethers.js ，用来写部署/升级脚本的）
